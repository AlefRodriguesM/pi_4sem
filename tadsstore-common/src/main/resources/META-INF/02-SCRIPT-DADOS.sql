...
INSERT INTO TB_VENDA (FK_COMPRADOR, DT_VENDA, VL_PRODUTOS, VL_FRETE, VL_TOTAL, DS_ENDERECO, DS_NUMERO, DS_BAIRRO, DS_CIDADE, DS_CEP, DS_FORMAPAG, DS_TRANSPORTADORA, TG_STATUS, DT_ALTERACAO) 
VALUES (1, CURRENT_TIMESTAMP, 2199.99, 20, 2229.99, 'PROF. CARLOS REIS', '39', 'PINHEIROS', 'SÃO PAULO', '05424020', 'BOLETO', 'RELAMPAGO', 1, NULL)
...
INSERT INTO TB_VENDA (FK_COMPRADOR, DT_VENDA, VL_PRODUTOS, VL_FRETE, VL_TOTAL, NR_PARCELAS, NR_PRAZOINI, NR_PRAZOFIM, DS_ENDERECO, DS_NUMERO, DS_BAIRRO, DS_COMPLEMETO, DS_CIDADE, DS_UF, DS_CEP, DS_FORMAPAG, DS_TRANSPORTADORA, TG_STATUS, DT_ALTERACAO)
...
INSERT INTO TB_CLIENTES(DS_NOME, DS_SOBRENOME, DS_EMAIL, DS_SENHA, DS_ENDERECO, DS_NUMERO, DS_BAIRRO, DS_COMPLEMENTO, DS_CIDADE, DS_UF, DS_CEP, DT_CADASTRO) VALUES('VITOR', 'LIMA COSTA', 'vitor.lcosta@outlook.com', 'senha123', 'Paulo de Barros', '451', 'Cidade Dutra', '', 'São Paulo', 'SP', '04807-000', CURRENT_TIMESTAMP);