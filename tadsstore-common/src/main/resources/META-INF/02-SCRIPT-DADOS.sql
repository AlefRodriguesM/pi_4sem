...
INSERT INTO TB_ITEMVENDA(FK_PRODUTO, FK_PEDIDO, QT_VENDA, VL_PREUNI, VL_TOTAL, DH_MOVIMENTO) VALUES (1, 1000, 1, 2199.99, 2199.99, CURRENT_TIMESTAMP)
...
INSERT INTO TB_CLIENTES (DS_NOME, DS_SOBRENOME, DS_EMAIL, DS_SENHA, DS_ENDERECO, DS_NUMERO, DS_BAIRRO, DS_COMPLEMENTO, DS_CIDADE, DS_UF, DS_CEP, DT_CADASTRO, DS_PAPEL) VALUES
('Alef', 'Mendes', 'alef@mail.com', '123', 'Av. Gonçalo de Paiva Gomes', '237', 'Jd. Primavera', 'Casa 02', 'São Paulo', 'SP', '04812-090', CURRENT_TIMESTAMP, 'CLIENTE')
;
INSERT INTO TB_CLIENTES (DS_NOME, DS_SOBRENOME, DS_EMAIL, DS_SENHA, DS_ENDERECO, DS_NUMERO, DS_BAIRRO, DS_COMPLEMENTO, DS_CIDADE, DS_UF, DS_CEP, DT_CADASTRO, DS_PAPEL) VALUES
('Vitor', 'Costa', 'vitor@mail.com', '123', 'Av. Gonçalo de Paiva Gomes', '237', 'Jd. Primavera', 'Casa 02', 'São Paulo', 'SP', '04812-090', CURRENT_TIMESTAMP, 'BACKOFFICE')
